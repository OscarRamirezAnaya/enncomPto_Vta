<?php 
		...
		$rows = $db->query($query);
            ...
            $query2 = 'SELECT name , id  FROM categoriap';
...
<div class="col-md-3 panel panel-body">	
	...
	<div class="form-group ">
      ...
      <div class="form-group ">
            <label for="idCliente">Categoria</label>
            <select name="idProducto" id="idProducto" class="form-control">
            <option value="0">Seleccione Categoria</option>
            <?php while($array2 = mysql_fetch_object($rows2)){ ?>

            <option value="<?php echo $array2->id; ?>"> <?php echo $array2->name; ?></option>
